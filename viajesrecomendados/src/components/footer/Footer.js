      ...
      <section>
        <p className="footer-p2">
          <span role="img" aria-label="Code" className="am-footer__code mr-1">
            <span
              aria-hidden="true"
              className="am-font-awesome am-font-awesome--code">
          ...
          Desarrollado con
          <span role="img" aria-label="love" className="am-footer__love mx-1">
            <span
              aria-hidden="true"
              className="am-font-awesome am-font-awesome--heart">
          ...
          y
          <span role="img" aria-label="coffee" className="am-footer__coffee mx-1">
            <span
              aria-hidden="true"
              className="am-font-awesome am-font-awesome--coffee">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
